...
if spoon.WinWin then
    ...
    hs.hotkey.bind(keyCombo, 'tab', function()
      spoon.ModalMgr:toggleCheatsheet()
    end)

    hs.hotkey.bind(keyCombo, "H", function()
      spoon.WinWin:stepResize("left")
    end)
    hs.hotkey.bind(keyCombo, "K", function()
      spoon.WinWin:stepResize("up")
    end)
    hs.hotkey.bind(keyCombo, "J", function()
      spoon.WinWin:stepResize("down")
    end)
    hs.hotkey.bind(keyCombo, "L", function()
    ...
    -- hsresizeM_keys = hsresizeM_keys or {"alt", "H"}
    -- if string.len(hsresizeM_keys[2]) > 0 then
    --     spoon.ModalMgr.supervisor:bind(hsresizeM_keys[1], hsresizeM_keys[2], "Enter resizeM Environment", function()
    --         hs.alert.show("Binding something")
